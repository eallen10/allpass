import { CREATE_NEW_USER_SUCCESS, CREATE_NEW_USER_REQUEST, CREATE_NEW_USER_FAILURE } from "../constants/newUserConstants";
...
export const createNewUser = (
    fname, lname, email, username, pass1, pass2, apiKey
  ) => {
    return dispatch => {
