  ...
  render() {
    let requestMessage = () => {
      if (this.props.createSuccess === undefined) {
        ...
        return [
          <Typography>
            Success! Click 'Login' and login using your username and password
          </Typography>
        ];
      } else {
    ...
    return (
      <div
        ...
        <Grid container style={{ marginTop: 0, padding: 16 }} spacing={2}>
          <Grid item xs={12}>
            <Typography>
              You have been given permission to create an account. Please
...
export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(CreateNewUser)
);
